    ...
    <div class="container">
        ...
        <table class="table table-hover mt-3" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                ...
                ?>
                @php
                $pivot = DB::table('users')->where('role', 'rs')->get()->all();
                @endphp
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{url('rs/store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        <input type="number" name="jam" class="form-control" placeholder="Jam buka">
                    </div>
                    <div class="input-group mb-3">
